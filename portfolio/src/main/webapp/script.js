...
// This function draws the interactive chart with the current votes.
function drawChart() {
  fetch('/chocolateData')
      .then(response => response.json())
      .then((chocolateVotes) => {
...
// This function clears all votes on the interactive chart.
...
function createMap() {
  ...
  var darwinsContent =
      '<p> I have been ordering sandwiches from Darwins for 14 years. At one point, I was ordering two sandwiches' +
  ...
  var darwinsInfoWindow = new google.maps.InfoWindow({content: darwinsContent});
  ...
  var jpContent =
      '<p> Whenever my brother is in town from NYC, we go to JP Licks every night. My favorite flavor is Brownie Brownie Batter or ' +
  ...
  var jpInfoWindow = new google.maps.InfoWindow({content: jpContent});
  ...
  var flourContent =
      '<p> Flour Bakery opened in Harvard Square a few years ago and I have been obsessed ever since. My go to order is a chopped greek salad ' +
  ...
  var flourInfoWindow = new google.maps.InfoWindow({content: flourContent});
